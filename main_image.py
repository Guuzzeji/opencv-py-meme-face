...
#sys.argv[1] == image 1
#sys.argv[2] == image 2
#sys.argv[3] == faceSwap or ChangeFacePos
#sys.argv[4] == save ouput
#sys.argv[5] == image number
...
# getting images
img = cv2.imread(sys.argv[1])#cut out face
img2 = cv2.imread(sys.argv[2])#back face and model face
print(img2.shape)
...
cv2.imwrite(sys.argv[4]+"/clone"+ sys.argv[5] +".jpeg", seamlessclone)
print("done")
